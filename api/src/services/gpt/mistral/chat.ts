    ...
    const callModel = async (state: typeof MessagesAnnotation.State) => {
      const promptTemplate = ChatPromptTemplate.fromMessages([
        new SystemMessage(
          ...
          Si vous pensez que cela s'avère utile pour faire une meilleure réponse, vous demanderez les informations suivantes : mesure, âge de la personne concernée, lieu de résidence.
